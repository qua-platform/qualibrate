...
from qualibrate.api.routes.local_storage.data_file import (
    local_storage_data_file_router,
)
...
local_storage_router.include_router(local_storage_data_file_router)
