  ...
  const imageDataType = defineDataType({
    ...
    Component: ({ value }) => {
      const handleImageClick = () => {
        ...
        win?.document.write(`<img src='${value}' alt="img" style="max-width: 100%; height: auto;" />`);
      };
        ...
        <div>
          ...
          <div className="figure-container">
            ...
            <a onClick={handleImageClick} style={{ cursor: "pointer" }}>
              <img style={{ maxWidth: "100%", height: "auto" }} src={(value as string) || undefined} alt="Base64 figure" />
            </a>
          </div>
        </div>
      );
  ...
  return (
    ...
    >
      ...
      <InputField
        value={searchTerm}
        title={"Search"}
        onChange={(_e: unknown, event: ChangeEvent<HTMLInputElement>) => handleSearch(event.target.value, event)}
      ></InputField>
      <JsonViewer
        rootName={false}
