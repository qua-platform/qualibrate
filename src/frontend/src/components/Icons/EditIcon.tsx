...
export const EditIcon: React.FunctionComponent<IconProps> = ({ width = 13, height = 13, className }) => (
  <svg width={width} height={height} className={className} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
