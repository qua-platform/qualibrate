  ...
  return (
    <div className={styles.dataWrapper}>
      <div className={styles.data}>
        <div className={styles.headerPanel}>
          ...
          <div className={styles.searchFilterContainer}>
            ...
            <DateFilter
              ...
              setTo={handleSetTo}
              onSelect={handleOnDateFilterSelect}
            />
          ...
          <div className={classNames(styles.searchFilterContainer, styles.wrapAppliedFilters)}>
            ...
            {selectedTags.map((tag) => (
              <AppliedFilterLabel value={tag} showDot={true} dotColor={stringToHexColor(tag)} onRemove={() => handleToggleTag(tag)} />
            ))}
          </div>
        </div>
        ...
        <PaginationWrapper numberOfPages={numberOfPages} isLoading={isLoading} setPageNumber={handleSetPageNumber} />
      </div>
    </div>
  );
};
