...
class TestIdToLocalPath:
    ...
    def test_get_path(self, mocker):
        patched_id2plp = mocker.MagicMock(spec=project_local_path_id.IdToProjectLocalPath)
        patched_id2plp.get_path.return_value = "some_path"
        patched_get_manager = mocker.patch.object(self.id2lp, "get_project_manager", return_value=patched_id2plp)
    ...
    def test_get_path_or_raise_path_is_none(self, mocker):
        patched_get = mocker.patch.object(self.id2lp, "get_path", return_value=None)
    ...
    def test_get_or_raise_path_is_not_none(self, mocker):
        patched_get = mocker.patch.object(self.id2lp, "get_path", return_value="node_path")
