...
def mock_qualibrate_examples(tmp_path):
    ...
    (calibrations_dir / "01_demo_qubit_spectroscopy.py").write_text(
        "# Demo calibration 1"
    )
...
class TestSetupDemoOnFirstRun:
    ...
    def test_handles_missing_calibrations_directory(
        self, temp_config_path, mock_qualibrate_examples
    ):
...
class TestFirstRunDetection:
    ...
    def test_first_run_condition_true_when_config_missing(
        self, temp_config_path
    ):
