...
class TestValidateInputParameters:
    ...
    def test_valid_parameters_pass_validation(self, sample_parameters_class):
    ...
    def test_valid_parameters_with_defaults(self, sample_parameters_class):
    ...
    def test_type_coercion_works(self, sample_parameters_class):
...
class TestGetActiveLibraryOrError:
    ...
    def test_returns_library_when_exists(self, mock_lib_class, mock_library):
...
class TestRunNodeHappyPath:
    ...
    def test_sets_run_item_to_node(self, mock_node, fresh_state):
    ...
    def test_creates_last_run_with_running_status(self, mock_node, fresh_state):
    ...
    def test_updates_state_with_finished_status(self, mock_node, fresh_state):
    ...
    def test_captures_snapshot_idx(self, mock_node, fresh_state):
    ...
    def test_captures_run_summary(self, mock_node, fresh_state):
    ...
    def test_sets_completed_at_timestamp(self, mock_node, fresh_state):
...
class TestRunNodeErrorPath:
    ...
    def test_captures_exception_in_state(self, mock_node, fresh_state):
    ...
    def test_captures_traceback(self, mock_node, fresh_state):
    ...
    def test_state_updated_even_on_error(self, mock_node, fresh_state):
    ...
    def test_snapshot_idx_negative_one_on_error(self, mock_node, fresh_state):
